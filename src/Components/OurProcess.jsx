...
// const OurProcess = () => {
//     return (
//         <Box textAlign="center" sx={{ marginTop: '4rem', paddingX: { xs: 2, sm: 4 },maxHeight:'100vh'  }}>
...
//             <Box sx={{ position: 'absolute', marginTop: '2rem', textAlign: 'center',flexDirection:'column' }}>
