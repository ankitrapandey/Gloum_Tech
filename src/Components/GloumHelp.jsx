...
//             },
//           ].map((service, index) => (
//             <Accordion key={index} TransitionProps={{ timeout: 500 }} sx={{ backgroundColor: 'transparent', color: '#fff' }}>
//               <AccordionSummary
...
export default function GloumHelp() {
  ...
  const handleAccordionChange = (panel) => (event, isExpanded) => {
    setExpanded(isExpanded ? panel : false); // Set expanded panel or close all
  };
